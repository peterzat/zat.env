...
- [ ] `/spec` creates a well-formed SPEC.md with goal, acceptance criteria, context, and metadata footer
...
<!-- SPEC_META: {"date":"2026-03-28","title":"Complete v1 skill suite and validate /spec integration","criteria_total":9,"criteria_met":3} -->
